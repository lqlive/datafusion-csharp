...
internal sealed class ClickHouseDialect
{
    ...
    public string ParameterName(int index) => $"@df_filter_{index}";

    public string OperatorSql(StreamingTableFilterOperator op) => op switch
    {
