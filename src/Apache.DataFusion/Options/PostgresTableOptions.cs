...
public sealed class PostgresTableOptions
{
    public PostgresTableOptions(string connectionString, string tableName)
    {
    ...
    public static PostgresTableOptions Create(string connectionString, string tableName) =>
